...
export default function AboutPage() {
  return (
    <div className="min-h-screen bg-gray-950 text-gray-200 py-20 px-6 flex flex-col items-center">
      <div className="max-w-3xl w-full">
        
        {/* Botón Volver */}
        <Link href="/" className="inline-flex items-center gap-2 text-yellow-500 hover:text-yellow-400 mb-12 text-sm font-medium group">
        ...
        <div className="space-y-6 text-lg leading-relaxed text-gray-300" style={{ fontFamily: "'Georgia', serif" }}>
            ...
            <ul className="list-disc pl-6 space-y-4 text-gray-400 mt-4">
                <li><strong className="text-white">Preservar:</strong> Crear un respaldo visual de la arquitectura latinoamericana que resista el paso del tiempo y los cambios tecnológicos.</li>
        ...
        <div className="mt-16 text-center">
            <Link href="/" className="px-8 py-3 bg-yellow-500 hover:bg-yellow-400 text-black font-bold rounded-lg transition shadow-lg">
                Explorar el Muro
            </Link>
        </div>
